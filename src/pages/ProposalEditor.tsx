      ...
      supabase.from("proposals").select("*").eq("id", id).single().then(({ data }) => {
        if (data) {
          setForm({
            ...
            company_reg_number: (data as any).company_reg_number || '',
            registered_address_1: (data as any).registered_address_1 || '',
            registered_address_2: (data as any).registered_address_2 || '',
